...
var numArr = [1, 2, 3];
console.log(numArr);
var strArr = new Array(4); // 参数为数组的长度
strArr = ["h", "e", "l", "l", "o"];
console.log(strArr);
// 数组的解构
var x = numArr[0], y = numArr[1], z = numArr[2];
console.log(x, y, z);
// 数组迭代
for (var i in numArr) {
...
// 二维数组
var multiNumArr = [[123], [234]];
console.log(multiNumArr);
// 作为参数传递给函数
var hello = function (paramArr) {
    for (var j in paramArr) {
...
// typescript 的数组跟 静态语言的数组还是有差别的,是以数组为对象,而不是以数组的元素的数据类型为对象.
